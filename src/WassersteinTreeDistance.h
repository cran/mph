#ifndef WAVELETSIMILARITY_H
#define WAVELETSIMILARITY_H
...
class WaveletSimilarity : public Visitor{
private:
...
public:
  ...
  std::map<int, DenseVector<TPrecision> > &getSigmaPsi(){
    return s_psi;
  };

  DenseMatrix<TPrecision> distances(){
